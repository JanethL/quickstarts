...
== For any questions:
If you have any questions or need further assistance, please visit our https://support.teradata.com/community?id=community_forum&sys_id=9ebf975e1bf7f304682ca8233a4bcb8a[community forum] where you can get support and interact with other community members and get.
